<template>
  <section class="deals pb-120 mt-24">
    <div class="container container-lg">
      <div
        class="bg-neutral-600 rounded-48 bg-img"
        style="background-image: url(/images/bg/pattern-two.png)"
      >
          ...
          <div class="col-xl-6 d-md-block d-none">
            <div class="position-relative px-24">
                ...
                <li class="products-group__list pt-12">
                  ...
                  >
                    <div class="product-card__thumb rounded-8 bg-gray-50 position-relative">
                      <NuxtLink to="/product-details-two" class="w-100 h-100 flex-center">
                        <img
                    ...
                    <div class="product-card__content mt-16 w-100">
                      <h6 class="title text-2xl fw-semibold my-8">
                        <NuxtLink to="/product-details-two" class="link text-line-2" tabindex="0"
                          >Women's fashion Bag</NuxtLink
                        >
                      </h6>
                      ...
                      <div class="flex-align gap-6">
                        <span class="text-lg fw-medium text-warning-600 d-flex"
                ...
                <li class="products-group__list pt-12">
                  ...
                  >
                    ...
                    <div class="product-card__content mt-16 w-100">
                      <h6 class="title text-2xl fw-semibold my-8">
                        <NuxtLink to="/product-details-two" class="link text-line-2" tabindex="0"
                          >Ivory Lace Peplum Top</NuxtLink
                        >
                      </h6>
                      <div class="product-card__price mt-8 mb-8">
                        <span class="text-neutral-600 text-lg fw-semibold">$24.00 USD</span>
              ...
              <div class="text-end" data-aos="fade-up" data-aos-duration="600">
                <img
                  src="/images/thumbs/deals-img.png"
                  alt=""
              ...
              <div class="text-center border border-white rounded-80 rounded-top-right-0 p-56-px">
                <div class="p-56-px bg-white rounded-80 rounded-top-right-0">
                  <div class="max-w-472 mx-auto">
                    <span
                      class="text-white bg-neutral-600 py-8 px-16 rounded-pill fw-medium text-md mb-32 text-uppercase"
                      >Only For Today</span
                    >
                    <h3 class="mb-32 fw-medium text-uppercase">Deal of The Day</h3>
                    <p class="text-neutral-600">
                      Deal of the day for deals on consumer fashion cloths for many other great
                      daily offers
                    </p>
                  </div>
                  <div class="mt-48">
                    <div id="countdown24" class="countdown">
                      <ul class="countdown-list style-four flex-center flex-wrap gap-24">
                        <li>
                          <span
                            class="days flex-center w-80 h-80 fw-semibold text-white rounded-16 bg-main-two-600 text-28"
                          ></span>
                          <span
                            class="mt-8 text-neutral-600 text-xl text-uppercase fw-medium d-block text-center"
                            >Days</span
                          >
                        </li>
                        <li>
                          <span
                            class="hours flex-center w-80 h-80 fw-semibold text-white rounded-16 bg-main-two-600 text-28"
                          ></span>
                          <span
                            class="mt-8 text-neutral-600 text-xl text-uppercase fw-medium d-block text-center"
                            >Hour</span
                        ...
                        <li>
                          <span
                            class="minutes flex-center w-80 h-80 fw-semibold text-white rounded-16 bg-main-two-600 text-28"
                          ></span>
                          <span
                            class="mt-8 text-neutral-600 text-xl text-uppercase fw-medium d-block text-center"
                            >Min</span
                        ...
                        <li>
                          <span
                            class="seconds flex-center w-80 h-80 fw-semibold text-white rounded-16 bg-main-two-600 text-28"
                          ></span>
                          <span
                            class="mt-8 text-neutral-600 text-xl text-uppercase fw-medium d-block text-center"
                            >Sec</span
...
onMounted(() => {
  intervalId.value = initializeCountdown("countdown24", "2025-12-30T23:59:59", () => {});
});
