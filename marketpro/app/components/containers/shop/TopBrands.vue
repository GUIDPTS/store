<template>
  <div class="top-brand pb-80 overflow-hidden" data-aos="fade-up" data-aos-duration="600">
    <div class="container container-lg">
      <div class="border border-gray-100 p-24 rounded-16">
        ...
        <Swiper
          ...
          :speed="900"
          class="top-brand__slider"
        >
          <SwiperSlide v-for="brand in brandImages" :key="brand.id">
