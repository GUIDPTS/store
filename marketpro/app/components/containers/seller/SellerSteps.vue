<template>
  <section class="step py-80" data-aos="fade-up" data-aos-duration="600">
    <div class="position-relative z-1">
      <img
        src="/images/shape/curve-line-shape.png"
        alt="Image"
        ...
        <div class="row gy-4">
            ...
            <div class="step-content">
              <div class="section-heading ms-auto text-end">
                ...
                <span class="text-gray-600"
                  >Ready to sell? Launch your brand today with a powerful for new sellers and over
          ...
          <div class="col-lg-6">
            <div class="text-center">
              <NuxtImg src="/images/thumbs/steps.png" alt="Image" />
            </div>
          </div>
        </div>
      </div>
